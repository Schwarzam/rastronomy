...
impl Card {
    ...
    fn write_formatted_string<W: Write>(
        &self,
        writer: &mut W,
        mut string: String,
        bytes_count: &mut i32,
    ...
    pub fn parse_card(card_str: String) -> Self {
        ...
        if card_str.starts_with("COMMENT")
        ...
        if card_str.starts_with("HIERARCH") {
            ...
            keyword = card_str.splitn(2, '=').collect::<Vec<&str>>()[0]
                .trim()
                .to_string();
        }
    ...
    pub fn continue_card(card: &mut Card, card_str: String) {
        ...
        if card_str.starts_with("CONTINUE  ") {
            value = card_str.splitn(2, "CONTINUE  ").collect::<Vec<&str>>()[1]
                .trim()
                .replace("'", "")
                .to_string();
